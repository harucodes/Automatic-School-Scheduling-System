                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button onclick="openEditModal({{ json_encode($student) }})" class="text-maroon-600 hover:text-maroon-800 mr-3">
                                            <i class="fa-solid fa-pen-to-square mr-1"></i> {{ __('Edit') }}
                                        </button>
                                        <button onclick="confirmDelete({{ $student->id }})" class="text-red-600 hover:text-red-800">
                    ...
                    <form id="editForm" method="POST">
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            <button type="button" onclick="closeModal()"
                                class="px-4 py-2 border border-maroon-200 rounded-md text-sm font-medium text-maroon-800 hover:bg-maroon-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-mustard-500"> {{ __('Cancel') }}
                            </button>
                            <button type="submit"
