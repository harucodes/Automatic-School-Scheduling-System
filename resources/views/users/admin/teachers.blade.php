                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button onclick="openEditModal({{ json_encode($teacher) }})" class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-500 mr-3">
                                            {{ __('Edit') }}
                                        </button>
                                        <button onclick="confirmDelete({{ $teacher->id }})" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-500">
                                            {{ __('Delete') }}
                                        </button>
                                    </td>
                                </tr>
