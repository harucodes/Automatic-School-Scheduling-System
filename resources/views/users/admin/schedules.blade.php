                ...
                schedules.forEach(schedule => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button onclick="openEditModal(${JSON.stringify(schedule).replace(/"/g, '&quot;')})" class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-500 mr-3">
                                {{ __('Edit') }}
                            </button>
