                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button onclick="openEditModal({{ json_encode($section) }})" class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-500 mr-3">
                                            {{ __('Edit') }}
                                        </button>
                                        <button onclick="confirmDelete({{ $section->id }})" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-500">
                                            {{ __('Delete') }}
                                        </button>
                                    </td>
                                </tr>
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <form id="sectionForm" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="section_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                {{ __('Section Name') }} *
                            </label>
                        ...
                        <div class="mb-4">
                            <label for="section_level" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                {{ __('Grade Level') }} *
                            </label>
