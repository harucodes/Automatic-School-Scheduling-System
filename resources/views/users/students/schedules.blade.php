            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-maroon-200">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium text-maroon-800">Your Class Schedule</h3>
                        <a href="{{ route('student.schedule.export') }}"
                            class="px-4 py-2 bg-maroon-600 text-white rounded hover:bg-maroon-700 transition">
                            <i class="fa-solid fa-file-excel mr-1" aria-hidden="true"></i>
                            Export to Excel
                        </a>
                    </div>
                            ...
                            <table class="min-w-full bg-white rounded-lg">
                                <thead>
                                    <tr class="bg-maroon-100">
                                        ...
                                        <th class="py-3 px-4 text-left text-maroon-800">Time</th>
                                        <th class="py-3 px-4 text-left text-maroon-800">Subject</th>
                                        <th class="py-3 px-4 text-left text-maroon-800">Teacher</th>
                                        <th class="py-3 px-4 text-left text-maroon-800">Year</th>
                                        <th class="py-3 px-4 text-left text-maroon-800">Block</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b border-maroon-100 hover:bg-maroon-50">
                                        <td class="py-3 px-4 text-maroon-800">{{ $schedule->day }}</td>
                                        ...
                                        <td class="py-3 px-4 text-maroon-800">{{ $schedule->teacher->name ?? 'N/A' }}</td>
                                        <td class="py-3 px-4 text-maroon-800">{{ $schedule->section->section_name ?? 'N/A' }}</td>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="7" class="py-4 px-4 text-center text-maroon-600">No schedules found.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
